const brands = [
  { name: "The Rare Ingredient", title: "COLD PRESSED. SILKY. ONE INGREDIENT.", copy: "Cold pressed from wild Vitellaria nilotica in Northern Uganda, this rare balm melts on contact and absorbs quickly, delivering rich moisture with a silky finish.", year: "Northern Uganda", bg: "linear-gradient(90deg, rgba(23, 23, 19, 0.34), rgba(169, 120, 69, 0.36)), url('assets/real-shea-fruit-hands.jpeg')", panel: "#f4ead8", color: "#171713", gallery: ["assets/real-shea-fruit-hands.jpeg", "assets/real-woman-harvest-basket.jpeg", "assets/real-shea-tree-landscape.jpeg", "assets/real-cooperative-sorting.jpeg"] },
  { name: "The Silky Difference", title: "RARE TEXTURE. INSTANT ABSORPTION.", copy: "This is the shea most people haven't tried yet. A smooth texture that melts in fast, rather than the harder, heavier bar many people expect from shea butter.", year: "East African Nile Belt", bg: "linear-gradient(90deg, rgba(23, 23, 19, 0.34), rgba(169, 120, 69, 0.34)), url('assets/real-shea-tree-landscape.jpeg')", panel: "#e6d8bd", color: "#171713", gallery: ["assets/real-shea-fruit-hands.jpeg", "assets/real-field-harvest-wide.jpeg", "assets/real-shea-tree-landscape.jpeg", "assets/real-cooperative-processing.jpeg"] },
  { name: "One Jar Daily Care", title: "FACE. LIPS. BODY. HAIR ENDS.", copy: "A small amount softens dry skin, lips, elbows, hands, and hair ends. It melts quickly, feels silky, and keeps daily care simple.", year: "100% Nilotica Shea", bg: "linear-gradient(90deg, rgba(23, 23, 19, 0.30), rgba(169, 120, 69, 0.28)), url('assets/real-field-harvest-wide-alt.jpeg')", panel: "#fffaf1", color: "#171713", gallery: ["assets/real-shea-fruit-hands.jpeg", "assets/real-cooperative-sorting.jpeg", "assets/real-field-harvest-wide-alt.jpeg", "assets/real-woman-harvest-basket.jpeg"] },
  { name: "Women-Led Source", title: "DIRECT PARTNERSHIPS. SHARED VALUE.", copy: "Women led cooperatives in Northern Uganda gather wild fallen nuts. Cooperative premiums help support community infrastructure, financial independence, and tree conservation.", year: "Cooperative Sourcing", bg: "linear-gradient(90deg, rgba(23, 23, 19, 0.42), rgba(169, 120, 69, 0.36)), url('assets/real-field-harvest-wide.jpeg')", panel: "#d2b482", color: "#171713", gallery: ["assets/real-cooperative-sorting.jpeg", "assets/real-cooperative-processing.jpeg", "assets/real-field-harvest-wide.jpeg", "assets/real-woman-harvest-basket.jpeg"] }
];
